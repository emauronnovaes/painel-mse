(function (root, factory) {
  ...
  const OBRA_TOUR_360 = Object.freeze({
    ...
    // Mesmo link (projeto Constructin p=11517) vale pras 3 obras Novo
    // Nordisk — pedido explícito (2026-09-15): "o link do constructin será
    // válido para todas as Novo Nordisk".
    107: 'https://visi.constructin.com.br/#/v?t=edc798829d281af4cc43b80fec23cea2df9eeba26a78cc8a434257bedd774461&p=11517',
    108: 'https://visi.constructin.com.br/#/v?t=edc798829d281af4cc43b80fec23cea2df9eeba26a78cc8a434257bedd774461&p=11517',
  ...
  const CONFIG_SUPRIMENTOS_POR_OBRA = Object.freeze({
    ...
    107: Object.freeze({
      ...
      catalogoExtra: Object.freeze({
        ...
        'Painéis': Object.freeze(['BARRAMENTO', /^PDP-/, /^SP-/, /^LP-/]),
        'Instrumentação': Object.freeze(['TRANSMISSOR DE', 'CHAVE DE NIVEL', 'PONTO DE AMOSTRAGEM', 'MEDIDOR DE VAZAO', 'RESTRITOR DE FLUXO', 'INTERRUPTOR DE NIVEL', 'INTERRUPTOR DE PRESSAO', 'PRESSOSTATO', 'MANOVACUOMETRO', 'INTERRUPTOR DE DISCREPANCIA']),
        'Iluminação': Object.freeze(['LAMPADA', 'FAROL', 'BANCO DE BATERIAS', 'ILUMINACAO DE EMERGENCIA', 'CENTRAL DE ILUMINACAO']),
        'Detecção e Alarme': Object.freeze(['SENSOR DE OCUPACAO', 'BICO ACUSTICO', 'ACIONAMENTO MANUAL', 'MODULO DE', 'SINAL DE ALARME', 'BICO', 'CAPILAR', 'MODULO', 'SENSOR DE FALHA', 'DETECTOR DE CALOR', 'ANUNCIADOR', 'DISPLAY LCD', '4-2ANN', 'DETECTOR DE PRESENCA']),
        'Combate a Incêndio': Object.freeze(['MANGUEIRA DE INCENDIO', 'ABRIGO EMBUTIDO', 'EXTINTOR', 'ENGATE RAPIDO', 'FIRE PROOFING']),
        'Automação e Controle': Object.freeze(['ATUADOR', 'FONTE DE ALIMENTACAO', 'ALIMENTACAO']),
        'Válvulas e acessórios': Object.freeze(['FLTRO Y', 'SEM RETORNO', 'VEDACAO DOWTY', 'CESTO FILTRANTE', 'O-RINGS', 'ANEIS DE VEDACAO']),
        'Sistema de Supressão a Gás (Cilindro Piloto)': Object.freeze(['CONTEINER PILOTO', 'RECIPIENTE PILOTO', 'DISCO DE RUPTURA', 'PISTAO PNEUMATICO', 'TUBO DE ORIFICIO', 'ANSUL', 'MANGUEIRA DE ACIONAMENTO', 'ESTACAO DE']),
        'Tubulação Inox': Object.freeze(['TUBO EM ACO INOX', 'ASME BPE']),
        'Transformadores': Object.freeze(['TRANSFORMADOR']),
        'Aterramento': Object.freeze(['HASTE DE ATERRAMENTO', 'METAL DE SOLDAGEM', 'CONDUTOR ISOLADO', 'INTERCONEXAO DE CONDUTORES', 'CAPTOR', 'CAIXA DE INSPECAO']),
        'Concreto e Impermeabilização': Object.freeze(['ARGAMASSA', 'REBOCO', 'CHAPISCO']),
        'Louças e Metais': Object.freeze(['RALO', 'GREASE TRAP']),
        'Pintura': Object.freeze(['EMASSAMENTO']),
        'Poço de Visita': Object.freeze(['POCO DE VISITA']),
      }),
    }),
    91: Object.freeze({
    ...
    94: Object.freeze({
      ...
      catalogoExtra: Object.freeze({
        ...
        'Terraplanagem e Movimentação de Terra': Object.freeze(['ATERRO', 'FORNECIMENTO DE MATERIAL IMPORTADO', 'BOTA-FORA', 'BOTA FORA', 'PROTECAO DE TALUDE', 'EMPRESTIMO DE MATERIAL', 'RACHAO']),
        'Geossintéticos': Object.freeze(['GEOGRELHA', 'GEOTEXTIL']),
        'Drenos Especiais': Object.freeze(['DRENOS FIBROQUIMICOS', 'DRENO FIBROQUIMICO']),
        'Pavimentação (camadas e revestimento)': Object.freeze(['APLICACAO DA CAMADA', 'CBUQ', 'INTERTRAVADO', 'AREIA DE ASSENTAMENTO DO PAVER', 'IMPRIMACAO']),
        'Fundações e Estacas': Object.freeze(['ESTACA']),
        'Balanças e Pesagem': Object.freeze(['BALANCA']),
        'Fôrmas e Escoramento': Object.freeze(['MADEIRITE', 'SARRAFO DE', 'DESMOLDANTE', 'ARAME RECOZIDO']),
        'Estações de Tratamento (ETA/ETE)': Object.freeze([/\bETA\b/, /\bETE\b/]),
        'Contêineres e Instalações Provisórias': Object.freeze(['CONTAINER', /^WC$/]),
      }),
    }),
  });
